defmodule FarneboFloraWeb.PlantLiveTest do
  use FarneboFloraWeb.ConnCase

  import Phoenix.LiveViewTest
  import FarneboFlora.PlantsFixtures

  @create_attrs %{name: "some name", location: "some location", latin_name: "some latin_name", local_name: "some local_name"}
  @update_attrs %{name: "some updated name", location: "some updated location", latin_name: "some updated latin_name", local_name: "some updated local_name"}
